...
//                .route("host_route", r -> r.host("*.myhost.org").uri("http://httpbin.org")).route("rewrite_route",
//                        r -> r.host("*.rewrite.org").filters(f -> f.rewritePath("/foo/(?<segment>.*)", "/${segment}"))
//                                .uri("http://httpbin.org")).route("hystrix_route",
//                        r -> r.host("*.hystrix.org").filters(f -> f.hystrix(c -> c.setName("slowcmd")))
//                                .uri("http://httpbin.org")).route("hystrix_fallback_route",
